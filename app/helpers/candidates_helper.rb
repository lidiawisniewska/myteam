module CandidatesHelper
	def candidate_avatar(candidate)
		return 'n/a' if candidate.blank? || candidate.avatar.blank?
	...
	def candidate_linkedin_url(candidate)
		return 'n/a' unless candidate.linkedin.present?
	...
	def candidate_facebook_url(candidate)
		return 'n/a' unless candidate.facebook.present?
	...
	def candidate_twitter_url(candidate)
		return 'n/a' unless candidate.twitter.present?
